...
def free_bacon(score):
    ...
    point = 10 - ones_digit + tens_digit
    return point
    # END PROBLEM 2
...
def is_swap(player_score, opponent_score):
    ...
    opponent_ones, opponent_tens = opponent_score % 10, opponent_score // 10 % 10
...
def play(
    ...
    say:        Thecommenta ry function to call at the end fo the first turn.
    ...
    while score0 < goal and score1 < goal:
        if not who:
            ...
            if feral_hogs:
                if abs(dice_number - pre_score0) == 2:
                    score0 += 3
            pre_score0 = take_turn(dice_number, score1, dice)
            score0 += pre_score0
            ...
            if feral_hogs:
                if abs(dice_number - pre_score1) == 2:
                    score1 += 3
            pre_score1 = take_turn(dice_number, score0, dice)
            score1 += pre_score1
    ...
    def announce(score0, score1):
        if who == 0:
            ...
            if diff > running_high:
                print(f"{diff} point(s)! That's the biggest gain yet for Player 0")
                return announce_highest(0, score0, diff)
            elif diff == running_high:
                return announce_highest(0, score0, diff)
            else:
            ...
            if diff > running_high:
                print(f"{diff} point(s)! That's the biggest gain yet for Player 1")
                return announce_highest(1, score1, diff)
            elif diff == running_high:
                return announce_highest(1, score1, diff)
            else:
